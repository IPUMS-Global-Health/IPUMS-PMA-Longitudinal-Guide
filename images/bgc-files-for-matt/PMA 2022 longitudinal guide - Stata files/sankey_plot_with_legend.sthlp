...
{phang}
{bf:sankey_plot_with_legend} {hline 2} Module to produce Sankey Plots

                               Slightly modified version of sankey_plot.ado to allow display of a legend.
...
The small modification to allow legends was made by Dale Rhoda at Biostat Global Consulting.  (Dale.Rhoda@biostatglobal.com)
{p_end}
