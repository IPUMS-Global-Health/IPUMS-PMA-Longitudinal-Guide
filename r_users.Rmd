...
The `ipumsr` package is designed to help R users import and explore data extracts downloaded from IPUMS. As we'll see, categorical variables from IPUMS appear as **labelled integers** represented in R by a number and a label like this: 
